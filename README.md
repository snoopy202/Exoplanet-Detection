...
In the file :
models.py you can find the CNN model and the SVC model.
project_main.py you can find the script that run all the operations. To run the code you have to run only this file.
